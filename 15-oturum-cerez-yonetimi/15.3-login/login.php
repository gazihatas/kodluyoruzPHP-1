...
<?php
//HTML elementleri oluşup sayfa bittikten sonra çalışacak bölge.
//Burada error isimli session'u siliyoruz ki sayfayı yenilediğimizde bu session silinsin, hata tekrar gösterilmesin.
$_SESSION['error'] = null;
